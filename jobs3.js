...
var regions = ['Alsace','Aquitaine','Auvergne','Basse Normandie','Bourgogne','Bretagne','Centre','Champagne-Ardenne','Corse','Franche-ComtÈ','Haute Normandie','Ile-de-France','Languedoc-Roussillon','Limousin','Lorraine','Midi-PyrÈnÈes','Nord-Pas-de-Calais','Pays de la Loire','Picardie','Poitou-Charentes','Provence-Alpes-CÙte-d\'Azur','RhÙne-Alpes','Guadeloupe','Martinique','Guyane','La RÈunion','Mayotte'];
...
//     var line =
 js.push(child1 + ';' + res1  + ';' + res + ';');
	 fs.appendFile('testWrite3.txt', js[js.length-1]+"\n", "utf8", (err) => {
	  if (err) throw err;
	  console.log('ok!');
	});
    });
